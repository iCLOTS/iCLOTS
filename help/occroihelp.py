...
Help window display shows help documents for region of interest (no map) accumulation/adhesion application help
...
class HelpDisplay(tk.Toplevel):
    ...
    def __init__(self):
        ...
        namelabel = tk.Label(self, text="Multi-scale microfluidic accumulation/occlusion application help\n"
                                        "specialized for a rectangular region of interest")
