...
class HelpDisplay(tk.Toplevel):
    ...
    def __init__(self):
        ...
        ---Your files may fail to load if they are already open in Excel. This application will read temporary files
        ---created by having the file open. Please close any workbooks you're using before selecting a folder of files.
        ...
        ---that could be considered a feature, opportunity to use text-based metrics are not included in v0.1.0.
        ...
        -----v0.1.0 as it is understood to be a robust general-purpose approach to discovering natural
        ...
        ----A mosaic plot, a specialized stacked bar chart, displays the number of
