...
class HelpDisplay(tk.Toplevel):
    ...
    def __init__(self):
        ...
        --Err on the high side of maximum diameter, low side of minimum mass parameter, and high side of maximum mass parameters
        ---unless data is particularly noisy or there's a large amount of debris
        
        Output files:
        --Analysis files are named after the vudei (.xlsx, .png)
